...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章点赞表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `article_like` VALUES (2,2,100,'2026-03-15 00:42:09'),(3,3,100,'2026-03-15 02:33:27');
...
INSERT INTO `community_post_like` VALUES (10,22,100,'2026-03-14 19:18:49');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程点赞表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `course_like` VALUES (3,1,100,'2026-03-15 00:18:47');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='音乐点赞表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `music_like` VALUES (3,1,100,'2026-03-15 01:08:11');
...
INSERT INTO `recommend_course` VALUES (1,'视频01','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/视频01_1770102676077_6931.mp4','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/947fd789373318_1773394281215_9614.jpeg',24,'简介','0','admin','2025-11-08 20:19:08','','2026-03-13 17:31:23',NULL),(2,'视频02','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/视频01_1770102676077_6931.mp4','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/科技感蓝色背景~赋能跃升_蓄力共进_2_大有素材2.0_来自小红书网页版_1770102695210_5395.jpg',24,'简介','0','admin','2025-11-08 20:19:08','','2026-02-03 15:11:55',NULL),(3,'视频03','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/视频01_1770102676077_6931.mp4','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/科技感蓝色背景~赋能跃升_蓄力共进_2_大有素材2.0_来自小红书网页版_1770102695210_5395.jpg',24,'简介','0','admin','2025-11-08 20:19:08','','2026-02-03 15:11:55',NULL),(4,'视频04','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/视频01_1770102676077_6931.mp4','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/科技感蓝色背景~赋能跃升_蓄力共进_2_大有素材2.0_来自小红书网页版_1770102695210_5395.jpg',24,'简介','0','admin','2025-11-08 20:19:08','','2026-02-03 15:11:55',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=353 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=755 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-16  7:49:59
