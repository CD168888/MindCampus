...
) ENGINE=InnoDB AUTO_INCREMENT=235 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI 聊天消息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI 聊天会话表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `community_comment` (
  ...
  `student_id` bigint DEFAULT NULL COMMENT '评论人ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='社区评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='社区帖子表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='心理文章推荐表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recommend_course` (
  ...
  `chapters` int DEFAULT NULL COMMENT '章节数',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='心理课程推荐表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recommend_course` VALUES (1,'视频01','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/视频01_1770102676077_6931.mp4','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/947fd789373318_1773394281215_9614.jpeg','123',24,1,'0','简介','0','admin','2025-11-08 20:19:08','','2026-03-13 17:31:23',NULL),(2,'视频02','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/视频01_1770102676077_6931.mp4','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/科技感蓝色背景~赋能跃升_蓄力共进_2_大有素材2.0_来自小红书网页版_1770102695210_5395.jpg','123',24,1,'0','简介','0','admin','2025-11-08 20:19:08','','2026-02-03 15:11:55',NULL),(3,'视频03','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/视频01_1770102676077_6931.mp4','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/科技感蓝色背景~赋能跃升_蓄力共进_2_大有素材2.0_来自小红书网页版_1770102695210_5395.jpg','123',24,1,'0','简介','0','admin','2025-11-08 20:19:08','','2026-02-03 15:11:55',NULL),(4,'视频04','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/视频01_1770102676077_6931.mp4','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/科技感蓝色背景~赋能跃升_蓄力共进_2_大有素材2.0_来自小红书网页版_1770102695210_5395.jpg','123',24,1,'0','简介','0','admin','2025-11-08 20:19:08','','2026-02-03 15:11:55',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='心理音乐推荐表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recommend_music` VALUES (1,'樱花树下的约定 (热搜版)','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/M800004S6qav0Urrxj_1770101921595_7770.mp3','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/1685863265_1770101631825_7900.jpg','柯柯柯啊','',189,NULL,'0','admin','2026-02-03 14:53:59','admin','2026-02-03 14:59:04',NULL),(2,'一点归鸿','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/M8000006v5040XjCVG_1770102013326_0569.mp3','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/1005840501_1770101192709_4713.jpg','柯柯啊','',177,'','0','admin','2025-11-09 00:07:20','admin','2026-02-03 15:00:20','42'),(3,'樱花树下的约定 (热搜版)','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/M800004S6qav0Urrxj_1770101921595_7770.mp3','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/3_1773380349183_9768.png','柯柯柯啊','',189,NULL,'0','admin','2026-02-03 14:53:59','admin','2026-03-13 13:39:11',NULL),(4,'樱花树下的约定 (热搜版)','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/M800004S6qav0Urrxj_1770101921595_7770.mp3','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/4_1773380360116_7851.png','柯柯柯啊','',189,NULL,'0','admin','2026-02-03 14:53:59','admin','2026-03-13 13:39:22',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=337 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=742 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-13 21:18:48
