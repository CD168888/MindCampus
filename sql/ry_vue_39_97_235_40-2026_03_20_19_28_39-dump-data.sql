...
) ENGINE=InnoDB AUTO_INCREMENT=278 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI 聊天消息表';
...
INSERT INTO `ai_chat_message` VALUES (272,101,100,1,'查看该图片','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/13418306923684477_1773884413724_7471.jpeg','xiaodu','2026-03-19 09:40:29','xiaodu','2026-03-19 09:40:29',NULL),(273,101,100,0,'抱歉，我无法查看或处理图片内容。如果你有关于图片的问题或需要帮助的地方，请告诉我，我会尽力提供支持！',NULL,'system','2026-03-19 09:40:31','system','2026-03-19 09:40:31',NULL),(274,101,100,1,'图中的内容是？','https://sky-take-out-jcd.oss-cn-beijing.aliyuncs.com/upload/13418306923684477_1773884439428_4923.jpeg','xiaodu','2026-03-19 09:40:45','xiaodu','2026-03-19 09:40:45',NULL),(275,101,100,0,'图中展示了一幅简笔画，主体是一个简单的卡通人物形象。这个人物表情焦虑，眉头紧皱，眼睛睁大，似乎在思考或担忧某事。画面中有多个对话框，内容反映了内心的焦虑和自我怀疑：\n\n1. 顶部的对话框写着：“我能做好吗？”\n2. 左下角的对话框写着：“失败了怎么办？”\n3. 右下角的对话框写着：“如果失败了怎么办？”\n\n最上方的大字标题是“停止内耗”，这似乎是整幅图的主题，强调避免过度的自我怀疑和焦虑。\n\n底部的文字进一步强化了主题：“你有没有过这样的经历？” 这句话试图引起观众的共鸣，让他们反思自己是否也曾有过类似的内心挣扎。\n\n整体来看，这幅图通过简单的绘画和文字传达了关于自我怀疑和焦虑的信息，并呼吁人们停止这种“内耗”。',NULL,'system','2026-03-19 09:40:48','system','2026-03-19 09:40:48',NULL),(276,102,100,1,'我今天面试失败了，我现在很难受！','','xiaodu','2026-03-19 14:18:44','xiaodu','2026-03-19 14:18:44',NULL),(277,102,100,0,'听到你面试失败了，真的很难受……这完全是可以理解的！面试本身就很消耗心力，投入了时间、精力甚至期待，结果不如预期时，感到沮丧、自我怀疑、甚至疲惫，都是非常真实和正常的情绪反应。\n\n想告诉你：  \n🔹 一次面试的结果 ≠ 你的能力或价值。它可能受到很多因素影响——岗位匹配度、当天状态、面试官偏好、甚至运气。  \n🔹 失败不是终点，而是反馈。如果愿意，我们可以一起复盘（比如：面试中哪些问题让你卡住了？哪些回答你后来觉得可以更好？），把它变成下一次更从容的起点。  \n\n如果你现在只想安静待一会儿，也完全OK。照顾好自己的情绪比“立刻振作”更重要。  \n需要我陪你聊聊、帮你整理面试复盘要点、或者只是安静地听你说说发生了什么，我都在这里 🌟\n\n你愿意分享一下，这次面试是哪个方向/公司？或者，此刻最让你难受的是什么？',NULL,'system','2026-03-19 14:18:50','system','2026-03-19 14:18:50',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI 聊天会话表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ai_chat_session` VALUES (101,100,'图片查看受限','xiaodu','2026-03-19 09:40:28','xiaodu','2026-03-19 09:40:29',NULL),(102,100,'面试失利共情','xiaodu','2026-03-19 14:18:44','xiaodu','2026-03-19 14:18:44',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=371 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=793 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-20 19:28:45
