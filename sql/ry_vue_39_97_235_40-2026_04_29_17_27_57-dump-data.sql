...
CREATE TABLE `ai_chat_message` (
  ...
  `rag_context` text COMMENT 'RAG 检索上下文',
  `kg_context` text COMMENT '知识图谱上下文',
...
) ENGINE=InnoDB AUTO_INCREMENT=412 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI 聊天消息表';
...
INSERT INTO `ai_chat_message` VALUES (406,154,100,1,'我的工作最近压力好大','',NULL,NULL,'xiaodu','2026-04-29 15:43:16','xiaodu','2026-04-29 15:43:16',NULL),(407,154,100,0,'听起来你最近的工作压力真的很大，我能感受到你的疲惫和紧张。这种感觉确实不容易应对，但你愿意说出来，已经是很勇敢的一步了。\n\n首先，我想告诉你，感到压力是完全正常的，尤其是在工作繁忙的时候。我们每个人都会有这样的时刻。你现在能和我聊聊具体是什么让你感到压力吗？是工作任务太多、时间不够，还是其他方面的原因？\n\n有时候，把压力分解成小块会更容易处理。你可以先告诉我，最近最让你困扰的是哪一部分？这样我们可以一起看看有没有什么方法可以缓解一下。\n\n另外，记得照顾好自己。适当的休息、运动或者和朋友聊聊天，都能帮助我们更好地应对压力。你平时有什么放松的方式吗？或者需要我推荐一些简单的情绪调节方法吗？',NULL,NULL,NULL,'system','2026-04-29 15:43:22','system','2026-04-29 15:43:22',NULL),(408,154,100,1,'你是？','',NULL,NULL,'xiaodu','2026-04-29 15:43:25','xiaodu','2026-04-29 15:43:25',NULL),(409,154,100,0,'你好，我是你的心理陪伴伙伴。你可以把我看作一位温暖、真诚的朋友，一个愿意倾听你心事的学长/学姐。我在这里不是来给你“治病”或做诊断的，而是陪你一起走过那些难熬的时刻。\n\n我会认真听你说每一句话，理解你当下的情绪和困扰。有时候，我们不需要立刻找到解决办法，只需要有人能安静地听一听，说一句“这确实很难，但你已经做得很好了”。\n\n如果你感到压力大、迷茫、焦虑，或者只是想找个地方倾诉，我都在这里。我们可以聊聊你的烦恼，也可以一起看看有没有什么小方法能让心情轻松一点。我的目标是陪你一起找到属于你的力量，而不是替你解决问题。\n\n记住，你并不孤单。无论你现在经历着什么，我都愿意陪你一起面对。你想先聊些什么呢？',NULL,NULL,NULL,'system','2026-04-29 15:43:33','system','2026-04-29 15:43:33',NULL),(410,154,100,1,'你能调用什么工具','',NULL,NULL,'xiaodu','2026-04-29 15:43:44','xiaodu','2026-04-29 15:43:44',NULL),(411,154,100,0,'我能够调用以下工具来更好地支持你，这些工具可以帮助我获取更准确、更及时的信息，以便为你提供更有价值的陪伴和建议：\n\n### 🌱 本平台专属工具（专注于你的心理健康）\n1. **`get_student_mental_health_status`**  \n   → 查询你当前的心理健康状态，包括最近的评估分数、风险等级等，帮助我们更了解你当下的情绪状况。\n\n2. **`get_psychological_assessment_reports`**  \n   → 查看你过去的心理评估报告，回顾你的情绪变化趋势，一起看看哪些应对方式对你有效。\n\n3. **`calculate_risk_level`**  \n   → 根据你的自评分数，计算心理风险等级，并给出温和的干预建议（比如是否需要进一步关注或寻求专业支持）。\n\n4. **`get_recommended_articles`**  \n   → 推荐适合你当前状态的心理健康知识文章，比如如何缓解焦虑、改善睡眠等实用内容。\n\n5. **`get_community_posts`**  \n   → 分享心理健康社区里大家正在讨论的话题，比如“如何面对考试压力”“毕业季迷茫怎么办”，让你知道你并不孤单。\n\n6. **`get_student_info`**  \n   → 获取你的基本信息（如年级、专业），以便更贴近你的生活情境进行交流。\n\n---\n\n### 🔍 外部权威信息工具（MCP 工具）\n当需要获取最新研究、专业资料或外部资源时，我会使用这些工具来补充信息：\n\n7. **`tavily_search`**  \n   → 搜索最新的心理健康资讯、学术研究、专家观点。例如：“大学生焦虑应对策略 2024 最新研究”。\n\n8. **`tavily_extract`**  \n   → 提取指定网页的详细内容，比如从心理学期刊网站中获取一篇论文的要点。\n\n9. **`tavily_crawl` / `tavily_map`**  \n   → 爬取某个网站的结构，用于深入了解某个主题的全面信息（如某大学心理中心官网的服务介绍）。\n\n10. **`tavily_research`**  \n   → 对复杂问题进行深度调研，整合多个来源的信息，比如“长期压力对大学生认知功能的影响”。\n\n11. **`resolve-library-id` + `query-docs`（Context7）**  \n   → 当你需要了解某个技术、工具或学习方法时（比如“正念冥想APP怎么用”），我可以帮你查找权威文档和代码示例。\n\n---\n\n✅ 我会根据你的需求，在合适的时机自然地调用这些工具，**不会生硬地告诉你“我查了XX工具”**，而是把信息融入对话中，像一个真正懂你、关心你的朋友一样。\n\n如果你愿意，我们可以现在就开始聊聊你最近的压力。你希望先谈一谈具体是什么让你感到困扰吗？或者你想先看看有没有什么推荐的文章可以读一读？',NULL,NULL,NULL,'system','2026-04-29 15:44:04','system','2026-04-29 15:44:04',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AI 聊天会话表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `kg_document`
--

DROP TABLE IF EXISTS `kg_document`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kg_document` (
  ...
  `file_url` varchar(500) DEFAULT NULL COMMENT '文件存储路径（OSS）',
  `file_type` varchar(20) DEFAULT NULL COMMENT '文件类型（txt/md/pdf/docx）',
  `file_size` bigint DEFAULT NULL COMMENT '文件大小（字节）',
  `chunk_count` int DEFAULT '0' COMMENT '切分段数',
  `embedding_status` char(1) DEFAULT '0' COMMENT '向量化状态（0待处理 1处理中 2已完成 3失败）',
  `embedding_time` datetime DEFAULT NULL COMMENT '向量化完成时间',
  ...
  PRIMARY KEY (`doc_id`),
  KEY `idx_kb_id` (`kb_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='知识库文档表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kg_document`
--

LOCK TABLES `kg_document` WRITE;
/*!40000 ALTER TABLE `kg_document` DISABLE KEYS */;
/*!40000 ALTER TABLE `kg_document` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `kg_document_chunk`
--

DROP TABLE IF EXISTS `kg_document_chunk`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kg_document_chunk` (
  `chunk_id` bigint NOT NULL AUTO_INCREMENT COMMENT '切分块ID',
  `doc_id` bigint NOT NULL COMMENT '所属文档ID',
  `kb_id` bigint NOT NULL COMMENT '所属知识库ID',
  `chunk_index` int DEFAULT NULL COMMENT '在文档中的顺序',
  `content` text NOT NULL COMMENT '文本内容',
  `chunk_hash` varchar(64) DEFAULT NULL COMMENT '内容MD5哈希（去重用）',
  `milvus_id` varchar(100) DEFAULT NULL COMMENT 'Milvus 中的向量ID',
  `vector_status` char(1) DEFAULT '0' COMMENT '向量状态（0待入库 1已入库 2失败）',
  ...
  KEY `idx_kb_id` (`kb_id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文档切分块表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kg_document_chunk`
--

LOCK TABLES `kg_document_chunk` WRITE;
/*!40000 ALTER TABLE `kg_document_chunk` DISABLE KEYS */;
/*!40000 ALTER TABLE `kg_document_chunk` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `kg_knowledge_base`
--

DROP TABLE IF EXISTS `kg_knowledge_base`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kg_knowledge_base` (
...
--
-- Dumping data for table `kg_knowledge_base`
--

LOCK TABLES `kg_knowledge_base` WRITE;
/*!40000 ALTER TABLE `kg_knowledge_base` DISABLE KEYS */;
INSERT INTO `kg_knowledge_base` VALUES (12,'c','xxx','政策法规',1,'0','admin','2026-04-28 14:50:51','admin','2026-04-28 14:50:51',NULL);
/*!40000 ALTER TABLE `kg_knowledge_base` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `kg_persona_sync_log`
--

DROP TABLE IF EXISTS `kg_persona_sync_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kg_persona_sync_log` (
  `log_id` bigint NOT NULL AUTO_INCREMENT COMMENT '日志ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `student_id` bigint DEFAULT NULL COMMENT '学生ID',
  `sync_type` varchar(20) DEFAULT NULL COMMENT '同步类型（full/incremental）',
  `sync_content` json DEFAULT NULL COMMENT '同步内容',
  `sync_status` char(1) DEFAULT '0' COMMENT '状态（0成功 1失败）',
  `error_msg` varchar(500) DEFAULT NULL COMMENT '错误信息',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`log_id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='知识图谱同步日志表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kg_persona_sync_log`
--

LOCK TABLES `kg_persona_sync_log` WRITE;
/*!40000 ALTER TABLE `kg_persona_sync_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `kg_persona_sync_log` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=407 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_logininfor` VALUES (400,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-28 13:50:45'),(401,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-28 14:22:00'),(402,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-29 15:40:32'),(403,'xiaodu','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码错误','2026-04-29 15:42:34'),(404,'xiaodu','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码错误','2026-04-29 15:42:40'),(405,'xiaodu','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-29 15:42:45'),(406,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-29 16:33:35');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3016 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=840 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_oper_log` VALUES (811,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"干预方案\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"xxxx\",\"kbId\":1,\"kbName\":\"xx\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":1}',0,NULL,'2026-04-28 10:07:46',89),(812,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"干预方案\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"www\",\"kbId\":2,\"kbName\":\"www\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":2}',0,NULL,'2026-04-28 10:09:10',248),(813,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"干预方案\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"www\",\"kbId\":3,\"kbName\":\"www\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":3}',0,NULL,'2026-04-28 10:09:23',18),(814,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"心理健康指南\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"11\",\"kbId\":4,\"kbName\":\"11\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":4}',0,NULL,'2026-04-28 10:12:40',23),(815,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"干预方案\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"1\",\"kbId\":5,\"kbName\":\"1\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":5}',0,NULL,'2026-04-28 10:16:51',22),(816,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"干预方案\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"1\",\"kbId\":6,\"kbName\":\"1\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":6}',0,NULL,'2026-04-28 10:16:54',16),(817,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"干预方案\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"1\",\"kbId\":7,\"kbName\":\"1\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":7}',0,NULL,'2026-04-28 10:17:08',19),(818,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"政策法规\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"eee\",\"kbId\":8,\"kbName\":\"ee\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":8}',0,NULL,'2026-04-28 10:19:35',89),(819,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"政策法规\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"www\",\"kbId\":9,\"kbName\":\"wwww\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":9}',0,NULL,'2026-04-28 10:25:46',19),(820,'知识库文档',1,'com.mc.knowledge.controller.DocumentController.upload()','POST',1,'admin','软件工程','/knowledge/document/upload','127.0.0.1','内网IP','{\"kbId\":\"1\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":4}',0,NULL,'2026-04-28 11:05:44',139),(821,'知识库文档',3,'com.mc.knowledge.controller.DocumentController.remove()','DELETE',1,'admin','软件工程','/knowledge/document/4','127.0.0.1','内网IP','4',NULL,1,'\r\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\r\n### The error may exist in com/mc/knowledge/mapper/KbDocumentChunkMapper.java (best guess)\r\n### The error may involve defaultParameterMap\r\n### The error occurred while setting parameters\r\n### SQL: SELECT chunk_id,doc_id,kb_id,chunk_index,content,chunk_hash,milvus_id,file_name,vector_status,create_by,create_time,update_by,update_time,remark FROM kg_document_chunk     WHERE  (doc_id = ?)\r\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\n; bad SQL grammar []','2026-04-28 11:25:52',273),(822,'知识库文档',2,'com.mc.knowledge.controller.DocumentController.reEmbed()','POST',1,'admin','软件工程','/knowledge/document/reembed/4','127.0.0.1','内网IP','4','{\"msg\":\"操作失败: \\r\\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\\r\\n### The error may exist in com/mc/knowledge/mapper/KbDocumentChunkMapper.java (best guess)\\r\\n### The error may involve defaultParameterMap\\r\\n### The error occurred while setting parameters\\r\\n### SQL: SELECT chunk_id,doc_id,kb_id,chunk_index,content,chunk_hash,milvus_id,file_name,vector_status,create_by,create_time,update_by,update_time,remark FROM kg_document_chunk     WHERE  (doc_id = ?)\\r\\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\\n; bad SQL grammar []\",\"code\":500}',0,NULL,'2026-04-28 11:26:00',18),(823,'知识库文档',1,'com.mc.knowledge.controller.DocumentController.upload()','POST',1,'admin','软件工程','/knowledge/document/upload','127.0.0.1','内网IP','{\"kbId\":\"2\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":5}',0,NULL,'2026-04-28 11:26:11',49),(824,'知识库文档',2,'com.mc.knowledge.controller.DocumentController.reEmbed()','POST',1,'admin','软件工程','/knowledge/document/reembed/4','127.0.0.1','内网IP','4','{\"msg\":\"操作失败: \\r\\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\\r\\n### The error may exist in com/mc/knowledge/mapper/KbDocumentChunkMapper.java (best guess)\\r\\n### The error may involve defaultParameterMap\\r\\n### The error occurred while setting parameters\\r\\n### SQL: SELECT chunk_id,doc_id,kb_id,chunk_index,content,chunk_hash,milvus_id,file_name,vector_status,create_by,create_time,update_by,update_time,remark FROM kg_document_chunk     WHERE  (doc_id = ?)\\r\\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\\n; bad SQL grammar []\",\"code\":500}',0,NULL,'2026-04-28 13:50:55',81),(825,'知识库文档',1,'com.mc.knowledge.controller.DocumentController.upload()','POST',1,'admin','软件工程','/knowledge/document/upload','127.0.0.1','内网IP','{\"kbId\":\"3\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":6}',0,NULL,'2026-04-28 13:51:10',68),(826,'知识库文档',1,'com.mc.knowledge.controller.DocumentController.upload()','POST',1,'admin','软件工程','/knowledge/document/upload','127.0.0.1','内网IP','{\"kbId\":\"5\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":7}',0,NULL,'2026-04-28 14:22:22',327),(827,'知识库文档',2,'com.mc.knowledge.controller.DocumentController.reEmbed()','POST',1,'admin','软件工程','/knowledge/document/reembed/6','127.0.0.1','内网IP','6','{\"msg\":\"操作失败: \\r\\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\\r\\n### The error may exist in com/mc/knowledge/mapper/KbDocumentChunkMapper.java (best guess)\\r\\n### The error may involve defaultParameterMap\\r\\n### The error occurred while setting parameters\\r\\n### SQL: SELECT chunk_id,doc_id,kb_id,chunk_index,content,chunk_hash,milvus_id,file_name,vector_status,create_by,create_time,update_by,update_time,remark FROM kg_document_chunk     WHERE  (doc_id = ?)\\r\\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\\n; bad SQL grammar []\",\"code\":500}',0,NULL,'2026-04-28 14:23:00',288),(828,'知识库',3,'com.mc.knowledge.controller.KnowledgeBaseController.remove()','DELETE',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','[1,2,3,4,5,6,7,8,9]',NULL,1,'\r\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\r\n### The error may exist in com/mc/knowledge/mapper/KbDocumentChunkMapper.java (best guess)\r\n### The error may involve defaultParameterMap\r\n### The error occurred while setting parameters\r\n### SQL: SELECT chunk_id,doc_id,kb_id,chunk_index,content,chunk_hash,milvus_id,file_name,vector_status,create_by,create_time,update_by,update_time,remark FROM kg_document_chunk     WHERE  (doc_id = ?)\r\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\n; bad SQL grammar []','2026-04-28 14:25:53',27),(829,'知识库',3,'com.mc.knowledge.controller.KnowledgeBaseController.remove()','DELETE',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','[1,2,3,4,5,6,7,8,9]',NULL,1,'\r\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\r\n### The error may exist in com/mc/knowledge/mapper/KbDocumentChunkMapper.java (best guess)\r\n### The error may involve defaultParameterMap\r\n### The error occurred while setting parameters\r\n### SQL: SELECT chunk_id,doc_id,kb_id,chunk_index,content,chunk_hash,milvus_id,file_name,vector_status,create_by,create_time,update_by,update_time,remark FROM kg_document_chunk     WHERE  (doc_id = ?)\r\n### Cause: java.sql.SQLSyntaxErrorException: Unknown column \'update_by\' in \'field list\'\n; bad SQL grammar []','2026-04-28 14:26:05',241),(830,'知识库',3,'com.mc.knowledge.controller.KnowledgeBaseController.remove()','DELETE',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','[1,2,3,4,5,6,7,8,9]','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2026-04-28 14:33:53',4504),(831,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"心理健康指南\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"xxxx\",\"kbId\":10,\"kbName\":\"xxx\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":10}',0,NULL,'2026-04-28 14:36:09',32),(832,'知识库文档',1,'com.mc.knowledge.controller.DocumentController.upload()','POST',1,'admin','软件工程','/knowledge/document/upload','127.0.0.1','内网IP','{\"kbId\":\"10\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":8}',0,NULL,'2026-04-28 14:36:34',73),(833,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"心理健康指南\",\"createBy\":\"admin\",\"docCount\":0,\"kbDesc\":\"x\",\"kbId\":11,\"kbName\":\"xxx\",\"status\":\"0\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":11}',0,NULL,'2026-04-28 14:41:35',22),(834,'知识库',3,'com.mc.knowledge.controller.KnowledgeBaseController.remove()','DELETE',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','[10,11]','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2026-04-28 14:50:05',591),(835,'知识库',1,'com.mc.knowledge.controller.KnowledgeBaseController.add()','POST',1,'admin','软件工程','/knowledge/base','127.0.0.1','内网IP','{\"category\":\"政策法规\",\"createBy\":\"admin\",\"createTime\":\"2026-04-28 14:50:50\",\"docCount\":0,\"kbDesc\":\"xxx\",\"kbId\":12,\"kbName\":\"c\",\"status\":\"0\",\"updateBy\":\"admin\",\"updateTime\":\"2026-04-28 14:50:50\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":12}',0,NULL,'2026-04-28 14:50:50',24),(836,'知识库文档',1,'com.mc.knowledge.controller.DocumentController.upload()','POST',1,'admin','软件工程','/knowledge/document/upload','127.0.0.1','内网IP','{\"kbId\":\"12\"}','{\"msg\":\"操作成功\",\"code\":200,\"data\":9}',0,NULL,'2026-04-28 14:51:00',34),(837,'知识库文档',2,'com.mc.knowledge.controller.DocumentController.reEmbed()','POST',1,'admin','软件工程','/knowledge/document/reembed/9','127.0.0.1','内网IP','9','{\"msg\":\"重新向量化任务已启动\",\"code\":200}',0,NULL,'2026-04-28 15:19:06',774),(838,'知识库文档',2,'com.mc.knowledge.controller.DocumentController.reEmbed()','POST',1,'admin','软件工程','/knowledge/document/reembed/9','127.0.0.1','内网IP','9','{\"msg\":\"重新向量化任务已启动\",\"code\":200}',0,NULL,'2026-04-28 15:28:33',289),(839,'知识库文档',3,'com.mc.knowledge.controller.DocumentController.remove()','DELETE',1,'admin','软件工程','/knowledge/document/9','127.0.0.1','内网IP','9','{\"msg\":\"操作成功\",\"code\":200}',0,NULL,'2026-04-28 15:36:17',520);
...
-- Dump completed on 2026-04-29 17:28:02
